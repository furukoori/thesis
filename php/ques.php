...
<body>
  ...
  <form onsubmit="return confirm('次のページに進みますか？');" action="" method="POST">
    ...
    <p class="margin">私は早稲田大学人間科学部人間環境科学科４年の古郡一樹と申します。</br></br>
    本研究の目的は、環境ボランティアサークルの推薦システムの開発研究です。</br>
    このアンケートは、推薦システムのアルゴリズムで用いるモデル作成のため「全１０問の性格診断アンケート」実施するものです。</br></br>
    調査データは研究スタッフのもとに厳重に保管され、統計的に処理されます。個人のプライバシー保護については十分配慮し、あなたにご迷惑をおかけすることはありません。</br>
    ご協力いただきました調査データに基づき卒業論文を作成し、早稲田大学に提出することを予定しております。研究以外には使用いたしません。</br></br>
    上記の趣旨をご理解いただき、率直にありのままのお考えをご回答ください。なお、調査への協力は任意であり、協力しなかったことであなたが不利益を被ることはありません。アンケート調査への回答および送信によって本研究への協力について同意したこととみなさせていただきます。</br></br>
    回答には3分程度かかります。</br>
    不明な点がありましたら、下記にご連絡ください。</br></br>
    ＜問い合わせ先＞</br>
    研究実施者：早稲田大学人間科学部人間環境科学科　古郡一樹(ふるこおりかずき)</br>
    e-mail：fukurou3moon@ruri.waseda.jp</br></br>
    研究責任者：早稲田大学人間科学部教授　西村昭治(にしむらしょうじ)</br>
    住所：〒359-1192 所沢市三ヶ島2-579-15 早稲田大学人間学術院</br>
    電話番号：04-2947-6707</br>
    e-mail：kickaha@waseda.jp</br></br>

    では質問に移ります。</br>
    性格診断の前に、少しだけ個人情報をお伺いします。</br>
    </p>
    <div class="ques">
    <p>性別を選んでください。</p>
    ...
    <div class="ques">
    <p>学籍番号の下2桁を記入してください。</br>例)学籍番号が「1j16d123-4」なら下2桁は「34」</p>
    <ul>
      <li>重複回答防止のためのみに利用します。</li>
      <li>早大生以外の方はご自身の学校の学籍番号下2桁の構いません。</li>
    </ul>
